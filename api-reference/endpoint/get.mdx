---
title: "Get User"
api: "GET https://api.ltwo.io/api/v1/user"
description: "This endpoint returns if the cache has the user along with the confidence score and user id"
---
...
```bash cURL
curl --location --request GET 'https://api.ltwo.io/api/v1/user' \
