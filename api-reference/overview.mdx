...
4. [Order Income Summary](#order-income-summary)
...
Retrieves a summary of an Individual's income based on the income related Items, including salary and other income related information. Ltwo uses a set of heuristics to make a final determination summarized as Reason Codes.